(function () {
  ...
  const notes = {
    hiq: {
      ...
      body: "Early product engineering: shipping UI, debugging real flows, and learning what makes software useful.",
    },
    curology: {
      label: "Curology",
      title: "Product engineering foundation",
      body: "Frontend and product work turned into a deeper backend and systems foundation.",
    },
    ethos: {
      label: "Ethos",
      title: "Joined Ethos as fullstack",
      body: "Started in fullstack product engineering, close to customer-facing workflows and the backend services behind them.",
    },
    ethosPlatform: {
      label: "Ethos",
      title: "Moved deeper into platform",
      body: "Later work focused on Kubernetes, deploy automation, Postgres migrations, eventing, service boundaries, and production operations.",
      href: "projects/event-bus/",
      linkText: "Read the event bus deep dive",
    },
    anime: {
      label: "AnimePics",
      title: "0 to 1 GenAI product",
      body: "Founder-led image generation product with checkout, uploads, custom model training, async GPU jobs, and media delivery.",
    ...
    intuit: {
      ...
      body: "Marketplace, recommendation, and real-time workforce optimization systems with measurable business impact.",
    },
    intuitMatching: {
      label: "Intuit",
      title: "AI contact center matching",
      body: "Customer-to-expert matching shaped by embeddings, queue coverage, availability, and operational constraints.",
      href: "projects/ai-contact-center-matching/",
      linkText: "Open the matching deep dive",
    },
    intuitGateway: {
      label: "Intuit",
      title: "AI agent gateway",
      body: "Agent workflows across web UI, Slack, Claude Code, MCP, and service APIs, designed for real production boundaries.",
      href: "projects/ai-agent-gateway/",
      linkText: "Open the agent gateway deep dive",
    },
    current: {
      label: "Current lane",
      title: "Products from 0 to 1. Systems from 1 to millions.",
      body: "Applied AI, backend systems, platform infrastructure, and product ownership in one path.",
    },
    next: {
      label: "Finish",
      title: "Finish: current applied AI systems work",
      body: "The current chapter is applied AI, backend systems, platform ownership, and product judgment.",
    },
  };
